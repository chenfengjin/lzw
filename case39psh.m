...
mpc.gen = [
	30	400	    161.762	400	 140    1.0499	100	1	 500	200		5	   	32	2  0 7.5 1;
	35	300	    210.661	300	-100	1.0494	100	1	 400  	160		4	    32	2  0  6  1 ;
...
mpc.gencost = [
       ...
       0       0  100    0   120    0    140      0     160     0     180       0   200; %抽蓄1
       0       0  100    0   120    0    140      0     160     0     180       0   200;  %抽蓄2
    ];
